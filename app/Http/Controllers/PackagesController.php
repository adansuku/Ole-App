...
class PackagesController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $view = 'voyager::bread.browse-packages';

        if (view()->exists("voyager::$slug.browse-packages")) {
            $view = "voyager::$slug.browse-packages";
        }
     ...
     public function pdf(Request $request, $id)
    {
        ...
        $package = DB::table('packages')->where('id', $id)
                    ->first();
        $modelos =  json_decode($package->modelos, true);         
        $predataTypeContent = DB::table('modelos')->whereIn('id', $modelos)
                    ->get();          
        $pdf = PDF::loadView('voyager::bread.pdf-modelos', compact('dataType', 'predataTypeContent'));
